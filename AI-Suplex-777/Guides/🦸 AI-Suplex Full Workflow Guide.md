...
```
CYCLE PLAN  →  WEEKLY PLAN  →  TASKLIST  →  START  →  EXECUTE  →  CAPTURE  →  PROMOTE  →  END  →  MEMORY LOOP  →  REVIEW
                                                                                                     ├─ 3lm end
                                                                                                     ├─ 3lm learn
                                                                                                     ├─ 3lm promote
                                                                                                     └─ 3lm index
...
Wed-Fri   — 🚀 Start → work → 📄 Artifact → 💡 Insight → 🏁 End → 3lm end → learn → index (daily loop)
